...
- **Navegação**: Menu principal com links para ORIGINAIS, MULTIMARCAS e SOBRE NÓS.
- **Busca**: Barra de pesquisa para encontrar produtos.
- **Carrinho de Compras**: Ícone para acessar o carrinho.
- **Perfil do Usuário**: Acesso ao perfil do usuário.
